 ...
 */
public class ApprovedExpensesFragment extends Fragment {

    private LinearLayout linearLayoutErrorApproved;
    ...
    public ApprovedExpensesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_approved_expenses, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewApproved = view.findViewById(R.id.recycler_expenses_approved);
        linearLayoutErrorApproved = view.findViewById(R.id.linear_layout_error_approved);
...
//
        ...
        AndroidNetworking.get(Constants.GET_REQUISITION_URL_2)
                .setTag("Get Requisitons ApprovedExpenses")
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONArray(new JSONArrayRequestListener() {
                    @Override
                    public void onResponse(JSONArray response) {
                        if (response.length() > 0) { //if there is a response
                            linearLayoutErrorApproved.setVisibility(View.GONE);
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    recyclerViewApproved.setAdapter(requisitionDataExpensesAdapter);
...
//                            requisitionDataExpensesAdapter.loadNewData(requisitionDatas);
                            ...
                            linearLayoutErrorApproved.setVisibility(View.VISIBLE);
